...
class CandidatoSerializer(serializers.ModelSerializer):
    ...
    areas_interesse_ids = serializers.PrimaryKeyRelatedField(
        many=True, write_only=True, queryset=AreaAtuacao.objects.all(), source='areas_interesse'
    )
...
class VagaCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Vaga
        fields = ['titulo', 'descricao', 'requisitos', 'foto_vaga', 'area_atuacao', 
                 'modalidade', 'tipo_contrato', 'localizacao', 'salario_min', 
                 'salario_max', 'salario_a_combinar', 'pergunta_personalizada', 'data_limite']
